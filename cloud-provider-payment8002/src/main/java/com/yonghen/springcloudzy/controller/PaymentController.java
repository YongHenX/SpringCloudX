...
//     * @param id 主键
    ...
    public CommonResult<Payment> selectOne(@PathVariable("id") Long id) {
        ...
        CommonResult<Payment> aaa = new CommonResult<>(200, "aaa");
        aaa.getCode();
    ...
    public CommonResult<Payment> create(@RequestBody Payment payment) {
        ...
        return new CommonResult<Payment>(200, "insert success， serverPort：" + serverPort, insert);
    }
    ...
    public CommonResult<List<Payment>> queryAllByLimit(@RequestParam(defaultValue = "0") int offset,
        ...
        return new CommonResult<List<Payment>>(200, "select success， serverPort：" + serverPort, payment);
    }
